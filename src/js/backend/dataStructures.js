...
/*          DEFAULT CONFIGS                     */
/************************************************/
const FOURVOICES_AT_CHANNEL1 = 0;
const FOURVOICES_AT_4CHANNELS = 1;
const FULLVOICE_AND_OTHERS = 2;
const PITCH_BEND_ALL_CHANNELS = 3;
const TWELVE_VOICES_AT_CHANNEL1 = 4;
const WESTERN_CONFIG = 5;

const DEFAULT_CONFIGS = {
  // Initial configuration of Midi Thing as stated in the firmware
  [FOURVOICES_AT_CHANNEL1]: [
    [1, "Voice Note", MAXDACOUTPUT, MODE10V,  MIDIVOICENOTE, 0, 120,       1, 0],
    [2, "Voice LFO",  MAXDACOUTPUT, MODEPN5V, MIDIVOICELFO,  0, digOutMax, 1, 0],
    [3, "Voice ADSR", MAXDACOUTPUT, MODE10V,  MIDIVOICEADSR, 0, digOutMax, 1, 0],
    [4, "Voice Note", MAXDACOUTPUT, MODE10V,  MIDIVOICENOTE, 0, 120,       1, 3],
    [5, "Voice LFO",  MAXDACOUTPUT, MODEPN5V, MIDIVOICELFO,  0, digOutMax, 1, 3],
    [6, "Voice ADSR", MAXDACOUTPUT, MODE10V,  MIDIVOICEADSR, 0, digOutMax, 1, 3],
    [7, "Voice Note", MAXDACOUTPUT, MODE10V,  MIDIVOICENOTE, 0, 120,       1, 6],
    [8, "Voice LFO",  MAXDACOUTPUT, MODEPN5V, MIDIVOICELFO,  0, digOutMax, 1, 6],
    [9, "Voice ADSR", MAXDACOUTPUT, MODE10V,  MIDIVOICEADSR, 0, digOutMax, 1, 6],
    [10, "Voice Note", MAXDACOUTPUT, MODE10V,  MIDIVOICENOTE, 0, 120,       1, 9],
    [11, "Voice LFO",  MAXDACOUTPUT, MODEPN5V, MIDIVOICELFO,  0, digOutMax, 1, 9],
    [12, "Voice ADSR", MAXDACOUTPUT, MODE10V,  MIDIVOICEADSR, 0, digOutMax, 1, 9]
  ],
  [FOURVOICES_AT_4CHANNELS]: [
    [1, "Voice Note", MAXDACOUTPUT, MODE10V, MIDIVOICENOTE, 0, 120, 1, 0],
    [2, "Voice Osc", MAXDIGOUTPUT, MODE10V, MIDIVOICEOSC, 0, digOutMax, 1, 0],
    [3, "Voice ADSR", MAXDACOUTPUT, MODE10V, MIDIVOICEADSR, 0, digOutMax, 1, 0],
    [4, "Voice Note", MAXDACOUTPUT, MODE10V, MIDIVOICENOTE, 0, 120, 2, 3],
    [5, "Voice Osc", MAXDIGOUTPUT, MODE10V, MIDIVOICEOSC, 0, digOutMax, 2, 3],
    [6, "Voice ADSR", MAXDACOUTPUT, MODE10V, MIDIVOICEADSR, 0, digOutMax, 2, 3],
    [7, "Voice Note", MAXDACOUTPUT, MODE10V, MIDIVOICENOTE, 0, 120, 3, 6],
    [8, "Voice Osc", MAXDIGOUTPUT, MODE10V, MIDIVOICEOSC, 0, digOutMax, 3, 6],
    [9, "Voice ADSR", MAXDACOUTPUT, MODE10V, MIDIVOICEADSR, 0, digOutMax, 3, 6],
    [10, "Voice Note", MAXDACOUTPUT, MODE10V, MIDIVOICENOTE, 0, 120, 4, 9],
    [11, "Voice Osc", MAXDIGOUTPUT, MODE10V, MIDIVOICEOSC, 0, digOutMax, 4, 9],
    [12, "Voice ADSR", MAXDACOUTPUT, MODE10V, MIDIVOICEADSR, 0, digOutMax, 4, 9],
  ],
  [FULLVOICE_AND_OTHERS]: [
    [1, "Voice Note", MAXDACOUTPUT, MODE10V, MIDIVOICENOTE, 0, 120, 1, 0],
    [2, "Voice Velocity", MAXDACOUTPUT, MODE10V, MIDIVOICEVEL, 0, 127, 1, 0],
    [3, "Voice Gate", MAXDIGOUTPUT, MODE10V, MIDIVOICEGATE, 0, digOutMax, 1, 0],
    [4, "Voice ADSR", MAXDACOUTPUT, MODE10V, MIDIVOICEADSR, 0, digOutMax, 1, 0],
    [5, "Voice Osc", MAXDIGOUTPUT, MODE10V, MIDIVOICEOSC, 0, digOutMax, 1, 0],
    [6, "Voice LFO", MAXDACOUTPUT, MODE10V, MIDIVOICELFO, 0, digOutMax, 1, 0],
    [7, "Voice Note", MAXDACOUTPUT, MODE10V, MIDIVOICENOTE, 0, 120, 1, 6],
    [8, "Voice Osc", MAXDIGOUTPUT, MODE10V, MIDIVOICEOSC, 0, digOutMax, 1, 6],
    [9, "CC", MAXDACOUTPUT, MODE10V, MIDIMODECC, 0, 127, 1, 20],
    [10, "RPN", MAXDACOUTPUT, MODE10V, MIDIMODERPN, 0, 16383, 1, 1025],
    [11, "Start/Stop", MAXDIGOUTPUT, MODE10V, MIDISTARTSTOP, 0, digOutMax, 1, 0],
    [12, "Pitch Bend", MAXDACOUTPUT, MODEPN5V, MIDIPITCHBEND, 0, 16383, 1, 0],
  ],
  [PITCH_BEND_ALL_CHANNELS]: [
  ...
  [TWELVE_VOICES_AT_CHANNEL1]: [
    [1, "Voice Note", MAXDACOUTPUT, MODE10V, MIDIVOICENOTE, 0, 120, 1, 0],
    [2, "Voice Note", MAXDACOUTPUT, MODE10V, MIDIVOICENOTE, 0, 120, 1, 1],
    [3, "Voice Note", MAXDACOUTPUT, MODE10V, MIDIVOICENOTE, 0, 120, 1, 2],
    [4, "Voice Note", MAXDACOUTPUT, MODE10V, MIDIVOICENOTE, 0, 120, 1, 3],
    [5, "Voice Note", MAXDACOUTPUT, MODE10V, MIDIVOICENOTE, 0, 120, 1, 4],
    [6, "Voice Note", MAXDACOUTPUT, MODE10V, MIDIVOICENOTE, 0, 120, 1, 5],
    [7, "Voice Note", MAXDACOUTPUT, MODE10V, MIDIVOICENOTE, 0, 120, 1, 6],
    [8, "Voice Note", MAXDACOUTPUT, MODE10V, MIDIVOICENOTE, 0, 120, 1, 7],
    [9, "Voice Note", MAXDACOUTPUT, MODE10V, MIDIVOICENOTE, 0, 120, 1, 8],
    [10, "Voice Note", MAXDACOUTPUT, MODE10V, MIDIVOICENOTE, 0, 120, 1, 9],
    [11, "Voice Note", MAXDACOUTPUT, MODE10V, MIDIVOICENOTE, 0, 120, 1, 10],
    [12, "Voice Note", MAXDACOUTPUT, MODE10V, MIDIVOICENOTE, 0, 120, 1, 11]
  ],
  /*[WESTERN_CONFIG]: [
    [1,"Reset", MAXDIGINPUT, MODE10V, GENDIGINPUT, 0, digOutMax, 1, 0],
    [2,"Next", MAXDIGINPUT, MODE10V, GENDIGINPUT, 0, digOutMax, 1, 0],
    [3,"Aux 1",       MAXADCINPUT, MODE10V, GENADCINPUT, 0, 4096, 1, 0],
    [4,"Aux 2",       MAXADCINPUT, MODE10V, GENADCINPUT, 0, 4096, 1, 0],
    [5,"CV Input 1",  MAXADCINPUT, MODE10V, GENADCINPUT, 0, 4096, 1, 0],
    [6,"CV Input 2",  MAXADCINPUT, MODE10V, GENADCINPUT, 0, 4096, 1, 0],
    [7,"CV Input 3",  MAXADCINPUT, MODE10V, GENADCINPUT, 0, 4096, 1, 0], 
    [8,"CV Input 4",  MAXADCINPUT, MODE10V, GENADCINPUT, 0, 4096, 1, 0],
    [9,"Voice Note", MAXDACOUTPUT, MODE10V, GENDACOUTPUT, 0, 120, 1, 0],
    [10,"Voice Note", MAXDACOUTPUT, MODE10V, GENDACOUTPUT, 0, 120, 1, 0],
    [11,"Voice Note", MAXDACOUTPUT, MODE10V, GENDACOUTPUT, 0, 120, 1, 0],
    [12,"Voice Note", MAXDACOUTPUT, MODE10V, GENDACOUTPUT, 0, 120, 1, 0],
    [13,"Voice Osc", MAXDIGOUTPUT, MODE10V, GENDIGOUTPUT, 0, digOutMax, 1, 8],
    [14,"Voice Osc", MAXDIGOUTPUT, MODE10V, GENDIGOUTPUT, 0, digOutMax, 1, 9],
    [15,"Voice Osc", MAXDIGOUTPUT, MODE10V, GENDIGOUTPUT, 0, digOutMax, 1, 10],
    [16,"Voice Osc", MAXDIGOUTPUT, MODE10V, GENDIGOUTPUT, 0, digOutMax, 1, 11],
    [17,"Voice ADSR", MAXDACOUTPUT, MODE10V, GENDACOUTPUT, 0, digOutMax, 1, 8],
    [18,"Voice ADSR", MAXDACOUTPUT, MODE10V, GENDACOUTPUT, 0, digOutMax, 1, 9],
    [19,"Voice ADSR", MAXDACOUTPUT, MODE10V, GENDACOUTPUT, 0, digOutMax, 1, 10],
    [20,"Voice ADSR", MAXDACOUTPUT, MODE10V, GENDACOUTPUT, 0, digOutMax, 1, 11]
]*/
};
